...
function initDB() {
    ...
    if (xAuth == "?") {
       ...
       localDB.transaction(function(tx) {tx.executeSql('CREATE TABLE User(Id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, NomeUsuario TEXT NULL, TelefoneUsuario TEXT NULL, uVeiculo INTEGER NULL, Auth TEXT NULL);');});
