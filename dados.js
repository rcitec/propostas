...
function CalculaViagem() {
    ...
    // Frete Liquido
	xFreteLiquido = (xValorKmCobrado*xDistancia)-((xValorKmCobrado*xDistancia)*(xPorcentagemDesconto/100))+xOutros-xAjuste;
    ...
    // Desconto Total
    xDescontoTotal = (xDescontoFreteLiquido/(xFreteTotal+xPedagio))*100;
